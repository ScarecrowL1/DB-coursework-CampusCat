...
class Ui_userWindow(object):
    def setupUi(self, userWindow):
        ...
        self.catTabel.setGeometry(QtCore.QRect(120, 0, 721, 551))
    ...
    def retranslateUi(self, userWindow):
        ...
        self.witLocBox.setItemText(2, _translate("userWindow", "新建项目"))
        self.witLocBox.setItemText(3, _translate("userWindow", "主楼以及活动中心"))
        self.witLocBox.setItemText(4, _translate("userWindow", "T3~T5"))
        self.witLocBox.setItemText(5, _translate("userWindow", "T2、T6"))
        self.witLocBox.setItemText(6, _translate("userWindow", "运动场"))
        self.witLocBox.setItemText(7, _translate("userWindow", "研究生教学区"))
        ...
        self.feedLocBox.setItemText(2, _translate("userWindow", "新建项目"))
        self.feedLocBox.setItemText(3, _translate("userWindow", "主楼以及活动中心"))
        self.feedLocBox.setItemText(4, _translate("userWindow", "T3~T5"))
        self.feedLocBox.setItemText(5, _translate("userWindow", "T2、T6"))
        self.feedLocBox.setItemText(6, _translate("userWindow", "运动场"))
        self.feedLocBox.setItemText(7, _translate("userWindow", "研究生教学区"))
        self.feedFoodBox.setItemText(0, _translate("userWindow", "猫粮一号"))
