...
class Ui_adminWindow(object):
    ...
    def retranslateUi(self, adminWindow):
        ...
        self.addLocBox.setItemText(2, _translate("adminWindow", "新建项目"))
        self.addLocBox.setItemText(3, _translate("adminWindow", "主楼以及活动中心"))
        self.addLocBox.setItemText(4, _translate("adminWindow", "T3~T5"))
        self.addLocBox.setItemText(5, _translate("adminWindow", "T2、T6"))
        self.addLocBox.setItemText(6, _translate("adminWindow", "运动场"))
        self.addLocBox.setItemText(7, _translate("adminWindow", "研究生教学区"))
        ...
        self.witLocBox.setItemText(2, _translate("adminWindow", "新建项目"))
        self.witLocBox.setItemText(3, _translate("adminWindow", "主楼以及活动中心"))
        self.witLocBox.setItemText(4, _translate("adminWindow", "T3~T5"))
        self.witLocBox.setItemText(5, _translate("adminWindow", "T2、T6"))
        self.witLocBox.setItemText(6, _translate("adminWindow", "运动场"))
        self.witLocBox.setItemText(7, _translate("adminWindow", "研究生教学区"))
        ...
        self.feedFoodBox.setItemText(0, _translate("adminWindow", "猫粮一号"))
        ...
        self.feedLocBox.setItemText(2, _translate("adminWindow", "新建项目"))
        self.feedLocBox.setItemText(3, _translate("adminWindow", "主楼以及活动中心"))
        self.feedLocBox.setItemText(4, _translate("adminWindow", "T3~T5"))
        self.feedLocBox.setItemText(5, _translate("adminWindow", "T2、T6"))
        self.feedLocBox.setItemText(6, _translate("adminWindow", "运动场"))
        self.feedLocBox.setItemText(7, _translate("adminWindow", "研究生教学区"))
